...
# Load NetworkManager
#network_status=$(ps aux | grep NetworkManager | grep root && nmcli --fields "SECURITY,SSID")
...
chosen_network=$(echo -e "$toggle\n$wifi_list" | uniq -u | rofi -dmenu -theme /home/skilax/.config/bspwm/rofi/wifi.rasi -i -selected-row 1 -p "WIFI SSID" )
